...
function ContactUs(props: { show: boolean; onHide: any }) {
  ...
  return (
    <>
      <Modal
        ...
        keyboard={false}
        centered
        className="CustModalComcovermain ContactusFormcov"
      >
            ...
            <Col md={6}>
              <div className="ComsetmodlaForm">
                <Row>
                  ...
                  <ReCaptcha sitekey={process.env.NEXT_PUBLIC_APP_SITE_KEY} ref={captchaRef} />
                  <div style={{ color: "red" }}>{errors.recaptcha}</div>
                  <Col md={12}>
